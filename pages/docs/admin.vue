<template>
  <div class='article pa-4 pa-sm-6 pa-md-8'>
    <article>
      ...
      <ContentImage src='/images/docs/netlify_ui.png' alt='Ekran menu netlify' title='Menu Netlify CMS'></ContentImage>
      ...
      <ContentImage src='/images/docs/netlify_edit.png' alt='Ekran edycji netlify' title='Ekran edycji'></ContentImage>
      ...
      <ul>
        ...
        <li>Pole "description" okresla abstrakt strony (to, co wyświetla się w wyszukiwarce lub social media jako krótki
...
---
      ...
      <p>Pod front matter wpisujemy treść samego artykułu. W razie wątpliwości warto podpatrzeć jak wygląda to w już istniejących podstronach i stworzyć coś podobnego :)</p>
      ...
      <p>Ponieważ Github używa standardowego systemu Git do zarządzania trescią informator można go w całości ściągnąć i edytować
      dowolną aplikacją wspierającą Git, na przykład:</p>
      <ul>
        <li><a href='https://desktop.github.com/'>Github Desktop</a> - oficjalna aplikacja Github dla Windows i MacOS. Prawdopodobnie najbardziej
        wygodna dla nie-informatykóœ aplikacja do obsługi Git.</li>
        <li><a href='https://www.jetbrains.com/webstorm/'>Webstorm</a> - program do tworzenia aplikacji internetowych, używany do pisania
        kodu aplikacji informatora. Darmowy dla studentów.</li>
      </ul>
      <p>Niezaleznie od używanej aplikacji efektem jest folder na dysku z kopią całego informatora, w którym możemy dokonywać zmian (dowolnym edytorem tekstu).
      Po dokonaniu zmian należy je zatwierdzić (commit) oraz przesłać (push). Nowe wersje można pobrać za pomocą pull/update.</p>
      <p>Używanie aplikacji jest najbardziej wygodną opcją do wprowadzania dużych zmian, ale tak, jak z edytowaniem przez Github wymaga ręcznego pisania front matter.
